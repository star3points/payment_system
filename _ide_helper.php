...
namespace Illuminate\Support\Facades {
    ...
    class App
    {
         ...
         *
         * This method returns the first configured path in the array of views paths.
         *
         * @param string $path
         * @return string
         * @static
     ...
     * @method static \Illuminate\Mail\SentMessage|null plain(string $views, array $data, mixed $callback)
     * @method static string render(string|array $views, array $data = [])
     * @method static mixed onQueue(string $queue, \Illuminate\Contracts\Mail\Mailable $views)
     * @method static mixed queueOn(string $queue, \Illuminate\Contracts\Mail\Mailable $views)
     * @method static mixed laterOn(string $queue, \DateTimeInterface|\DateInterval|int $delay, \Illuminate\Contracts\Mail\Mailable $views)
    ...
    class Schema
    {
        ...
        /**
         * Get all of the views names for the database.
         *
         * @return array
         * @static
         */
...
'
    ...
    class View
    {
        ...
        /**
         * Get the rendered content of the views based on the negation of a given condition.
         *
         * @param bool $condition
         * @param string $view
         * @param \Illuminate\Contracts\Support\Arrayable|array $data
